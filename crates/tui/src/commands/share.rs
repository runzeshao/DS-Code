...
<title>DS Code Session Export</title>
<style>
  body {{
...
<div class="footer">
  Generated by DS Code · https://github.com/Hmbown/DS-Code
</div>
</body>
</html>"#,
    )
...
mod tests {
    ...
    fn test_render_session_html_metadata() {
        ...
        assert!(html.contains("https://github.com/Hmbown/DS-Code"));
    }
}
