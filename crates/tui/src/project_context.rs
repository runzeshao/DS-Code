//! Project context loading for DS Code.
//!
...
fn auto_generate_context(workspace: &Path) -> Option<String> {
    ...
    let content = format!(
        "# Project Structure (Auto-generated)\n\n\
         > This file was automatically generated by DS Code.\n\
...
This file provides guidance to AI agents (DS Code, Claude Code, etc.) when working with code in this repository.
