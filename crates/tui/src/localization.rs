...
fn english(id: MessageId) -> &'static str {
    match id {
        ...
        MessageId::HomeDashboardTitle => "DS Code Home Dashboard",
...
fn japanese(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::HomeDashboardTitle => "DS Code ホームダッシュボード",
...
fn chinese_simplified(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::HomeDashboardTitle => "DS Code 主面板",
...
fn portuguese_brazil(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::HomeDashboardTitle => "Painel Inicial do DS Code",
