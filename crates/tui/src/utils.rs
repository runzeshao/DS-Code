//! Utility helpers shared across the `ds` CLI.
...
/// 2. Writes a crash dump to `~/.ds/crashes/<timestamp>-<name>.log`.
///
...
/// Write a panic dump file to `~/.ds/crashes/`.
///
...
/// panics, a crash dump is written to `~/.ds/crashes/` and the panic
